...
<head>
    ...
    <meta name="description" content="{{ $ticket->description ? Str::limit($ticket->description, 160) : 'Day Tour Package - Lan-Jalan' }}">
    <title>{{ $ticket->title ?? 'Day Tour Package' }} - lan-jalan</title>
...
<div class="relative min-h-[950px]">
    ...
    <div class="relative z-10 ml-24 mt-8">
        <nav class="flex items-center gap-2 text-white text-sm opacity-80">
            ...
            <span>/</span>
            <a href="{{ route('daytourpack') }}" class="hover:text-[#FFD04D] transition-colors">Day Tour Package</a>
            <span>/</span>
    ...
    @if($related->count() > 0)
        <div class="mt-16">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h2 class="text-2xl font-bold italic">Other Packages</h2>
            </div>
                    ...
                    <div class="shadow-lg rounded-[50px] bg-white overflow-hidden flex flex-col hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div class="p-5 flex-1 flex flex-col">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                @if($item->slug)
                                    <a href="{{ route('daytourpack.show', $item->slug) }}"
